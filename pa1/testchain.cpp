...
{
    PNG img;
    img.readFromFile("images/rbg.png");
    ...
    PNG expected; expected.readFromFile("images/rbgoddreverse.png");
...
TEST_CASE("chain::basic even reverse", "[weight=1][part=chain]")
{
    ...
    PNG expected; expected.readFromFile("images/rbgevenreverse.png");
    REQUIRE(res == expected);
...
TEST_CASE("chain::long rotate k = 12", "[weight=1][part=chain]")
{
    ...
    PNG expected; expected.readFromFile("images/rbgrotate12.png");
